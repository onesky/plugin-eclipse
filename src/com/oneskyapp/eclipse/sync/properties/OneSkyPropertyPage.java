...
public class OneSkyPropertyPage extends PropertyPage {
	...
	protected Control createContents(final Composite parent) {
		...
		txtPublicKey.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
		...
		txtSecretKey.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 3, 1));
		...
		txtProjectGroupDetail.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		txtProjectDetail.setLayoutData(new GridData(SWT.FILL, SWT.TOP, true, false, 1, 1));
		new Label(composite, SWT.NONE);
	...
	protected void browseProjectGroups(){
		...
		OneSkyService service = new OneSkyServiceBuilder(publicKey, secretKey).build();
		
		List<ProjectGroup> projectGroups = service.getProjectGroupList().getProjectGroups();
